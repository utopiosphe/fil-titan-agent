...
build_and_package "$AGENT_DIR" "agent-darwin"

# Build and package controller
build_and_package "$CONTROLLER_DIR" "controller-darwin"

# 生成并显示 MD5 校验码
md5 "$RELEASE_DIR/agent-darwin-box.zip"
md5 "$RELEASE_DIR/controller-darwin-box.zip"
md5 "$RELEASE_DIR/agent-darwin.zip"
md5 "$RELEASE_DIR/controller-darwin.zip"
